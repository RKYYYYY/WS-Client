    ...
    <div className="flex flex-col mx-4 max-w-7xl w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8 mx-4">
        ...
        <input
          ...
          className="w-full bg-secondary-800 border border-secondary-700 rounded-xl px-4 py-3 text-secondary-100 placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent"
        />
